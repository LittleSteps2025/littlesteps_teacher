          ...
          onPress: async () => {
            ...
            try {
              ...
              if (success) {
                ...
                Alert.alert(
                  "Notification Failed",
                  "Could not notify parent. Please check your connection.",
                  [{ text: "OK" }]
                );
              }
            } catch (error) {
              ...
              Alert.alert(
                "Notification Failed",
                "Could not notify parent. Please try again.",
                [{ text: "OK" }]
              );
            }
          },
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          <View style={styles.profileHeader}>
            ...
            <View
              style={[styles.gradeTag, { backgroundColor: colors.secondary }]}
            >
          ...
          {!showSensitiveData ? (
            <View style={styles.section}>
              ...
              >
                ...
                <Text style={styles.sensitiveButtonText}>
                  View More Details
                </Text>
              </TouchableOpacity>
